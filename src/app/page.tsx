        ...
        <div>
          ...
          <div className="space-y-4">
            ...
            {submitMessage && (
              <div className={cn(
                "p-4 rounded-lg",
                submitMessage.type === 'success' && "bg-amber-900/20 border border-amber-900/50",
                ...
                {submitMessage.type === 'success' ? (
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="text-lg font-semibold text-white mb-2">✅ Vistoria Agendada com Sucesso!</h4>
                        <div className="space-y-1 text-amber-400">
                          <p className="text-sm">📅 <strong>Data:</strong> {submitMessage.scheduledDate}</p>
                          <p className="text-sm">🕐 <strong>Horário:</strong> {submitMessage.scheduledTime}</p>
                        </div>
                      </div>
                    </div>
